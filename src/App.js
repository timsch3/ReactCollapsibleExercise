...
function App() {
  return (
    <div className="App">
      <Collapsible trigger={faq[0].question}><p>{faq[0].answer}</p></Collapsible>
      <Collapsible trigger={faq[1].question}><p>{faq[1].answer}</p></Collapsible>
      <Collapsible trigger={faq[2].question}><p>{faq[2].answer}</p></Collapsible>
      <Collapsible trigger={faq[3].question}><p>{faq[3].answer}</p></Collapsible>
    </div>
  );
}
